...
// Serial Policy
  ...
  template<typename T>
  using FLECSI_RUNTIME_FUTURE_POLICY = serial_future_policy__<T>;
...
//Legion Policy
  ...
  template<typename T>
  using FLECSI_RUNTIME_FUTURE_POLICY = legion_future_policy__<T>;
...
// MPI Policy
  ...
  #include "flecsi/execution/mpi/future_policy.h"

  namespace flecsi {
  namespace execution {

  template<typename T>
  using FLECSI_RUNTIME_FUTURE_POLICY = mpi_future_policy__<T>;
